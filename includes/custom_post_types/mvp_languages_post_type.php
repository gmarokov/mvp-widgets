...
$labels = array(
	'name'                  => _x( 'Languages', 'Post Type General Name', 'mvp-widgets' ),
	'singular_name'         => _x( 'Languages', 'Post Type Singular Name', 'mvp-widgets' ),
	'menu_name'             => __( 'Languages', 'mvp-widgets' ),
	'name_admin_bar'        => __( 'Languages', 'mvp-widgets' ),
...
$args = array(
	'label'                 => __( 'Languages', 'mvp-widgets' ),
	'description'           => __( 'Languages', 'mvp-widgets' ),
	'labels'                => $labels,
	'supports' => array( 
		'title',
		'editor',
...
register_post_type( 'mvp_languages', $args );