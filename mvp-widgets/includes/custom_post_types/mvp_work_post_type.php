...
$labels = array(
    'name'                  => _x( 'Work', 'Post Type General Name', 'mvp-widgets' ),
    'singular_name'         => _x( 'Work', 'Post Type Singular Name', 'mvp-widgets' ),
    'menu_name'             => __( 'Work', 'mvp-widgets' ),
    'name_admin_bar'        => __( 'Work', 'mvp-widgets' ),
...
$args = array(
    'label'                 => __( 'Work', 'mvp-widgets' ),
    'description'           => __( 'Work', 'mvp-widgets' ),
    'labels'                => $labels,
    'supports' => array( 
        'title',
        'editor',
...
register_post_type( 'mvp_work', $args );